...
export const metadata: Metadata = {
  title: "Edible Flowers | Fit Plate",
  description: "Explore all Fit Plate edible flowers varieties.",
};

export default async function EdibleFlowers() {
  ...
  return (
    <main className="lv-page edible-flowers-page">
        ...
        <div className="container">
          <div className="lv-stats-grid">
            <div className="lv-stat-item">
              <div className="lv-stat-icon" style={{ backgroundColor: "#8F71B3", color: "white", borderColor: "white" }}>
              ...
              <div className="lv-stat-title" style={{ color: "#8F71B3" }}>Fresh Harvest</div>
              <div className="lv-stat-desc">7-21 days</div>
            </div>
            <div className="lv-stat-item">
              <div className="lv-stat-icon" style={{ backgroundColor: "#F991A4", color: "white", borderColor: "white" }}>
              ...
              <div className="lv-stat-title" style={{ color: "#F991A4" }}>Rich in Nutrients</div>
              <div className="lv-stat-desc">Vitamins & Minerals</div>
            </div>
            <div className="lv-stat-item">
              <div className="lv-stat-icon" style={{ backgroundColor: "#ECBA41", color: "white", borderColor: "white" }}>
              ...
              <div className="lv-stat-title" style={{ color: "#ECBA41" }}>Natural Flavour</div>
              <div className="lv-stat-desc">Pure & Clean</div>
            </div>
            <div className="lv-stat-item">
              <div className="lv-stat-icon" style={{ backgroundColor: "#A692D7", color: "white", borderColor: "white" }}>
              ...
              <div className="lv-stat-title" style={{ color: "#A692D7" }}>Better Nutrition</div>
              <div className="lv-stat-desc">For a Healthier You</div>
            </div>
          </div>
          <div className="lv-intro-text">
            Edible Flowers are young, edible seedlings harvested just after the cotyledons and first<br/>true leaves appear. Below is a quick reference to each variety we grow — its character,<br/>nutritional highlights, and where it shines on the plate.
          </div>
        </div>
      </section>
              ...
              return (
                <div key={v.id} className="lv-card">
                  ...
                  <div className="lv-card-content">
                    ...
                    <Link href={`/edible-flowers/${slug}`} className="lv-read-more" style={{ color: theme.text }}>
                      Read More &rarr;
                    </Link>
                  </div>
                </div>
      ...
      <section className="lv-nutrition" style={{ backgroundImage: "url(/assets/img/edible-flowers-third.png)" }}>
      ...
      <section className="lv-custom-mix section" style={{ backgroundImage: "url(/assets/img/edible-flowers-four.png)" }}>
