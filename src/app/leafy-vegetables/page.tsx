...
export const metadata: Metadata = {
  title: "Leafy Vegetables | Fit Plate",
  description: "Explore all Fit Plate leafy vegetable varieties.",
};

export default async function LeafyVegetables() {
  ...
  return (
    <main className="lv-page">
      {/* 1. Top Banner */}
      <section className="lv-hero" style={{ backgroundImage: bannerImg ? `url(${bannerImg})` : 'url(/assets/img/leafy-vegetables-hero.png)' }}>
      ...
      <section className="lv-stats section">
        <div className="container">
          ...
          <div className="lv-intro-text">
            Leafy vegetables are young, edible seedlings harvested just after the cotyledons and first<br/>true leaves appear. Below is a quick reference to each variety we grow — its character,<br/>nutritional highlights, and where it shines on the plate.
          </div>
        </div>
      </section>
              ...
              return (
                <div key={v.id} className="lv-card">
                  ...
                  <div className="lv-card-content">
                    ...
                    <Link href={`/leafy-vegetables/${slug}`} className="lv-read-more" style={{ color: theme.text }}>
                      Read More &rarr;
                    </Link>
                  </div>
                </div>
