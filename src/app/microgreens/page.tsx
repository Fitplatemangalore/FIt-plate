                  ...
                  <div className="testimonial-card">
                    ...
                    <div className="testimonial-google-badge">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#fff" }}>
                        <path d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.136 4.114-3.483 0-6.312-2.829-6.312 0-3.483 2.829-6.312 6.312-6.312 1.624 0 3.097.621 4.225 1.63l3.24-3.24C19.336 2.222 15.992 1 12.24 1 6.033 1 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 11.24-4.553 11.24-11.24 0-.761-.077-1.498-.216-2.185H12.24z" />
                      </svg>
                    </div>
                  </div>
                </a>
              ...
              <>
                <a href="https://maps.google.com/?q=Fitplate+Ventures+Mangalore" target="_blank" rel="noopener noreferrer" className="testimonial-link-card" style={{ "--i": 0 } as React.CSSProperties}>
                  <div className="testimonial-card">
                    ...
                    <div className="testimonial-google-badge">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" style={{ color: "#fff" }}>
                        <path d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.114-5.136 4.114-3.483 0-6.312-2.829-6.312 0-3.483 2.829-6.312 6.312-6.312 1.624 0 3.097.621 4.225 1.63l3.24-3.24C19.336 2.222 15.992 1 12.24 1 6.033 1 12.24s5.033 11.24 11.24 11.24c6.478 0 11.24-4.553 11.24-11.24 0-.761-.077-1.498-.216-2.185H12.24z" />
                      </svg>
                    </div>
                  </div>
                </a>
