      ...
      <div className="admin-editor-grid">
        ...
        <div className="admin-card">
          ...
          {loading ? (
            ...
            <p className="admin-muted" style={{ textAlign: "center" }}>No varieties configured. Add your first Leafy Vegetable!</p>
          ) : (
        ...
        <div className="admin-card">
          <h2 className="admin-card-title">
            {selectedId ? `Edit: ${formData.name}` : "New Leafy Vegetable"}
          </h2>
